...
class CreatePost extends StatefulWidget {
  ...
  const CreatePost({super.key, this.onCreated});
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: TosReviewSpacings.m),
                CustomTextField(label: "Price", hintText: "Enter the price", text: priceController),
                const SizedBox(height: TosReviewSpacings.m),
                CustomTextField(label: "Location", hintText: "Enter the location", text: locationController),
                const SizedBox(height: TosReviewSpacings.m),
                RichText(
                  text: TextSpan(
